	...
	<div id="wiki-content-sidebar" class="col-md-3 sidebar">
		<div class="sidebar-box">
			...
			<nav class="a-items">
				...
				<label for="contributors" class="accordion-label">
					<svg class="lexicon-icon lexicon-icon-users" viewBox="0 0 512 512">
						<path class="lexicon-icon-outline" d="M457.2197,329.6279c-16.056-18.3494-34.5182-33.0546-54.6105-43.7661c11.3163-16.2676,17.962-36.0161,17.962-57.2905
							...
							s36.5713,16.4058,36.5713,36.5713S340.165,265.1426,320,265.1426S283.4287,248.7368,283.4287,228.5713z"></path>
						<path class="lexicon-icon-outline" d="M246.8569,86.8569C246.8569,38.9639,207.8931,0,160,0S73.1431,38.9639,73.1431,86.8569
							...
							s22.8569,10.2534,22.8569,22.8569S172.6035,109.7144,160,109.7144S137.1431,99.4604,137.1431,86.8569z"></path>
					</svg>
